...
a task is missing it's necessary to review the `source code`_ to learn how to
use it. If a functionality is missing consider the `role config_light`_. See
various `examples`_. If *config_light* is not able to do what you want create
new tasks.
...
.. _role config_light: https://galaxy.ansible.com/vbotka/config_light/
